...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(characters.species) AS number_of_species FROM characters GROUP BY characters.species ORDER BY number_of_species DESC LIMIT 1"
end
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(characters.name) AS occurrence FROM characters
